...
<!--<section>
  <div class="hero-slider position-relative">
    ...
    <div class="hero-slider-item py-160" style="background-image: url(images/banner/banner-1.jpg);" data-icon=""
      data-text="">
      <div class="container">
        <div class="row">
          <div class="col-12">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
        <div class="card text-center">
          <h4 class="card-title pt-3">Performance Enhancement</h4>
          ...
          <div class="card-body p-0">
            ...
            <p class="card-text mx-2 mb-0">Enhance thrust and specific impulse, optimize combustion chamber and nozzle design, improve propellant efficiency.</p>
            <a href="#" class="btn btn-secondary translateY-25">Read
              More</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
        <div class="card text-center">
          <h4 class="card-title pt-3">Modal Analysis</h4>
          <div class="card-img-wrapper">
          ...
          <div class="card-body p-0">
            ...
            <p class="card-text mx-2 mb-0">Modal analysis is a powerful engineering technique used to determine a structure's vibrational characteristics. </p>
            <a href="#" class="btn btn-secondary translateY-25">Read
              More</a>
          </div>
        </div>
      ...
      <div class="col-lg-4 col-sm-6">
        <div class="card text-center">
          <h4 class="card-title pt-3">Dynamic Response Analysis</h4>
          <div class="card-img-wrapper">
          ...
          <div class="card-body p-0">
            ...
            <p class="card-text mx-2 mb-0">Dynamic Response Analysis is a crucial engineering technique that predicts how a structure will react to time-varying loads</p>
            <a href="#" class="btn btn-secondary translateY-25">Read
              More</a>
          </div>
        </div>
...
<section class="about section-sm overlay" style="background-image: url(images/background/rocket.png);">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 ml-auto">
                <div class="rounded p-sm-5 px-3 py-5 bg-secondary">
                    ...
                    <p class="text-white mb-40" style="text-align:justify;font-size: 17px;">Optimization of Rocket Engine and Structural Vibration (ORESV) as a pioneering research group dedicated to developing Rotating Detonation Engines (RDEs) for space and commercial transportation vehicles. The group's primary objectives include designing rocket engines and mitigating structural vibrations to foster innovation and advance the frontiers of space engineering.</p>
                    <!--<div>
...
<section class="section">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2 class="section-title section-title-border-half">About Us</h2>
      </div>
      <div class="col-lg-10">
        <div class="mb-40">
          <p class="text-dark" style="text-align:justify;">At ORESV, we are driven by a passion for pioneering research in aerospace engineering. Our research interests extend to the exploration of detonation engines (DEs) for space applications. The DE engines represent a revolutionary approach to propulsion systems, offering numerous advantages over conventional methods. With our early research efforts, we aim to unlock the full potential of detonation engines and pave the way for their adoption in various aerospace applications.</p>
            <p class="text-dark" style="text-align:justify;"><b>Benefits of Detonation Engines:</b>
              Detonation engines have the potential to redefine the future of propulsion technology. They offer superior performance, efficiency, and versatility compared to traditional airbreathing and rocket propulsion systems. The primary benefit of detonation engines is their higher thrust-to-weight ratios and greater specific impulse, which leads to higher efficiency and lower cost. The engines are also capable of providing greater thrust for longer durations.
          </p>
        </div>
        <!-- fun-fact -->
        <!--<div class="mb-md-50">
      ...
      <div class="col-lg-2 offset-lg-1">
        <!--<div class="progressbar">
          <h5 class="progressbar-title">Cutting-Edge Technology</h5>
        ...
        <div class="progressbar">
          <h5 class="progressbar-title">Client-Centric Approach</h5>
        ...
        <div class="progressbar">
          <h5 class="progressbar-title">Timely Delivery</h5>
        ...
        <div class="progressbar">
          <h5 class="progressbar-title">Cost-Effective Solutions</h5>
          <div class="progress" data-percent="90%">
            <div class="progress-bar progress-bar-striped" style="width: 90%;">
              <div class="progress-bar-value">90%</div>
            </div>
...
<!--          <img src="images/mission.jpg" alt="chart" class="" style="width: 500px;margin-left: -20px;height: 400px;">-->
...
<!-- work -->
<!--<section class="section bg-gray" style="padding: 60px 0;">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="mb-2" style="text-align: center;">Our Awesome Team</h2>
                <p class="mb-5" style="text-align: center;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
            ...
            <div class="col-lg-4 col-sm-6 mb-4">
                <div class="card text-center">
                    ...
                    <div class="card-body card-body-2 pb-0 px-4">
                        <h5 class="card-title">Babu</h5>
                        <h6 class="text-color mb-30">Developer</h6>
                        <ul class="list-inline border-top d-inline-block">
                            <li class="list-inline-item">
                                <a href="#" class="text-color d-inline-block p-3">
                                    <i class="ti-facebook"></i>
...
<!-- mission -->
<section class="mission section" id="about" style="border-bottom: 1px solid #e5e5e5;padding: 0 0;">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2 class="section-title section-title-border-half">Objectives</h2>
        <!--<div class="row">
          <div class="col-lg-6">
          ...
          <div class="card border-0 mb-4">
            <div class="card-header bg-gray border p-0">
              <a class="card-link h5 d-block text-dark mb-0 py-10 px-4" data-toggle="collapse" href="#collapseOne">
                <i class="ti-minus text-primary mr-2"></i> Our Mission
              </a>
            </div>
            <div id="collapseOne" class="collapse show" data-parent="#accordion">
              <div class="card-body font-secondary text-color pl-0 pb-0">
                <p style="text-align:justify;"> Our mission is to advance the development and implementation of detonation engines for space propulsion while addressing the challenges associated with high vibration levels. We are dedicated to ensuring the safety, reliability, and success of launch vehicles by mitigating the impact of broadband, severe, aero-acoustic, and structure-borne excitations. Through our research and innovation, we aim to safeguard the electronic survivability of payloads and vehicles, ultimately contributing to mission success and the advancement of space exploration.</p>
              </div>
            </div>
          </div>
          <div class="card border-0 mb-4">
            <div class="card-header bg-gray border p-0">
              <a class="collapsed card-link h5 d-block text-dark mb-0 py-10 px-4" data-toggle="collapse"
                href="#collapseTwo">
                <i class="ti-plus text-primary mr-2"></i> Our Vision
              </a>
            </div>
            <div id="collapseTwo" class="collapse" data-parent="#accordion">
              <div class="card-body font-secondary text-color pl-0 pb-0">
                <p style="text-align:justify;"> ORESV is to push the boundaries of space exploration and engineering innovation. We are driven by a commitment to integrate detonation engines (DEs) into launch vehicles, revolutionizing space travel. By harnessing the power of DEs and other advanced technologies, we aim to redefine the capabilities of space propulsion systems, opening new frontiers of exploration and discovery.</p>
              </div>
            </div>
          </div>
      ...
      <!-- chart -->
      <div class="col-lg-2">
<!--        <img src="images/mission.jpg" alt="chart" class="img-fluid w-100" style="height: 415px;margin-left: 50px;">-->
      </div>
    </div>
  </div>
</section>
